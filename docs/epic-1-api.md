...
`DATA_STALE_AFTER_MINUTES` defaults to 60 minutes. The frontend must use `data-status` before presenting crowd levels as recent information. The rationale and observed public-data latency are recorded in `docs/epic-1-data-freshness-decision.md`.
